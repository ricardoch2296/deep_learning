...
cabecera (compas y tonalidad), usa barras de repeticion (\texttt{|: :|}) y finales
alternativos (\texttt{|1 |2}), evidencia de que aprendio la estructura tipica de
un tune irlandes.

\begin{lstlisting}[caption={Tune generado por el mini-GPT (temperatura 0.9).},label=lst:tune]
X:1
M:4/4
K:Am
